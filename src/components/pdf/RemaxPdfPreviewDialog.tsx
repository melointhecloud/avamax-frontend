...
interface RemaxPdfPreviewDialogProps {
  open: boolean
  onClose: () => void
  reportData: any
...
export function RemaxPdfPreviewDialog({
  open,
  onClose,
  reportData,
  reportType,
  documentTitle,
}: RemaxPdfPreviewDialogProps) {
        ...
        <DialogHeader className="px-4 sm:px-6 py-3 sm:py-4 border-b shrink-0 flex flex-col gap-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-5 h-5 rounded" style={{ backgroundColor: '#CC0000' }} />
              <DialogTitle className="text-sm sm:text-base">
                AvaMax — Estudo de Mercado
              </DialogTitle>
            </div>
          </div>
          {/* Variant Toggle */}
          <div className="flex items-center gap-2 flex-wrap">
            <Button
              ...
              style={variant === 'quick' ? { backgroundColor: '#CC0000' } : {}}
            >
            ...
            <Button
              ...
              className="text-xs gap-1.5"
              style={variant === 'full' ? { backgroundColor: '#003DA5' } : {}}
            >
            ...
            <Button
              ...
              className="text-xs gap-1.5"
              style={darkMode ? { backgroundColor: '#003DA5', color: '#fff', borderColor: '#003DA5' } : {}}
            >
