...
export function MfrSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 hidden h-screen w-64 flex-col lg:flex bg-sidebar border-r border-border">
      {/* Logo AvaMax */}
      ...
      <div className="p-3 border-t border-border">
        <Button
          ...
          className="neu-press w-full justify-start gap-2 rounded-lg transition-all text-muted-foreground"
        >
