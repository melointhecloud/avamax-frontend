...
export function CeoSidebar() {
  ...
  return (
    <aside
      ...
      style={{
        background: 'linear-gradient(180deg, hsl(0 0% 100%) 0%, hsl(216 20% 98%) 100%)',
        borderRight: '1px solid hsl(216 20% 92%)',
      }}
    >
      {/* Logo AvaMax */}
      ...
      <div className="p-3 border-t" style={{ borderColor: 'hsl(216 20% 92%)' }}>
        <Button
          ...
          className="neu-press w-full justify-start gap-2 rounded-lg transition-all"
